...
import { View, Text, StyleSheet, Button, Image, TouchableOpacity } from 'react-native'; // Import Image
...
const CameraScreen = ({ route }) => {
  ...
  const sendFrameToServer = async (base64Frame) => {
    ...
    try {
      const response = await axios.post('http://192.168.10.41:5001/process_frame', {
        frame: base64Frame,
